...
PlatformShoes::SpriteSheet::SpriteSheet(const char* filename) {
  SDL_RWops   *rwop;
  SDL_Surface *image;
...
void PlatformShoes::SpriteSheet::_resizeSpriteArray() {
  Sprite* old = _sprites;
...
char* PlatformShoes::SpriteSheet::_determineStatSheetFilename(const char* filename) {
...
void PlatformShoes::SpriteSheet::_loadStatSheet(const char* filename) {
...
unsigned int PlatformShoes::SpriteSheet::texture() {
  return _texture;
}

void PlatformShoes::SpriteSheet::textureCoordinates(unsigned int index, double coords[4]) {
...
bool PlatformShoes::SpriteSheet::textureCoordinates(const char* name, double coords[4]) {
